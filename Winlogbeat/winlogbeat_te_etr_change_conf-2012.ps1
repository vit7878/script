...
[string[]]$computerNames = Get-Content -Path '\\etr-fs-01\Infrastructure\Distr\Winlogbeat\Domain_Srv_Win2012_KAV\servers_2012.txt'

#Если конфиг типовой, то менять не надо
$file_yml = '\\etr-fs-01\Infrastructure\Distr\Winlogbeat\Domain_Srv_Win2012_KAV\winlogbeat.yml'
